...
let personnames = ["sunil", "habil", "jasper"];
...
let transports = ["Honda motorcycle", "Tesla car", "Hodnda bicycle"];
...
let Myguests = ["samson", "sharoon", "sky"];
...
let places = ["germany", "Iceland", "U.S.A", "canada", "Itly"];
...
let Myguests2 = ["sunil", "habil", "jasper", "sky", "sameer"];
...
let countries = ["india", "dubai", "New Zealand", "korea", "africa"];
...
let favorite_fruits = ["peach", "bananas", "cherries"];
...
let new_users = ["User1", "User6", "user7", "admin", "User9", "User10"];
...
let pizzas = ["pepperoni", "tikka", "fajita", "meat pizza"];
pizzas.forEach(pizza => {
    console.log(`I like ${pizza} pizza.`);
});
console.log("I really love pizza!");
// Question 35: Animals: Highlight animals with a common trait.
let animals = ["dog", "loin", "horse"];
...
function my_shirt(size = "large", message = "I love TypeScript") {
    console.log(`Making a ${size} t-shirt with the message "${message}" printed on it.`);
}
my_shirt();
my_shirt("medium");
...
let magicians = ["David Blaine", "Derren Brown", "Teller", "Apollo"];
...
let magicians2 = ["David Blaine", "Derren Brown", "Teller", "Apollo"];
function make_great2(magicians) {
    let greatMagicians2 = []; // Removed the extra colon
    magicians.forEach(magician => {
...
function make_car(manufacturer, model, ...options) {
    let car = { manufacturer, model }; // Corrected object declaration and property assignment
